...
for i in range(1,51):
  ip=[]  
  url="https://www.amazon.in/New-Apple-iPhone-11-64GB/product-reviews/B08L8DV7BX/ref=cm_cr_dp_d_show_all_btm?ie=UTF8&reviewerType=all_reviews="+str(i)
...
with open("D:\\BLR10AM\\codes\\12.text mining\\Datasets NLP\\stop.txt","r") as sw:
    stop_words = sw.read()
...
with open("D:\\BLR10AM\\codes\\12.text mining\\Datasets NLP\\positive-words.txt","r") as pos:
...
with open("D:\\BLR10AM\\codes\\12.text mining\\Datasets NLP\\negative-words.txt", "r") as neg:
