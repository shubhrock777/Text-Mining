...
## Moana Movie #####
page= "https://www.imdb.com/title/tt0468569/reviews?ref_=tt_ql_3"
...
with open("C:\\Datasets_BA\\360DigiTMG\\DS_India\\360DigiTMG DS India Module wise PPTs\\Module 18 Text Mining_Natural Language Processing (NLP)\\Data\\positive-words.txt","r") as sw:
    stopwords = sw.read()
